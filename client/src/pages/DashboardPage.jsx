...
export const DashboardPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto h-full space-y-12">
      {/* Banner */}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {isLoading ? (
            ...
            data?.data?.projects?.slice(0, 3).map(project => (
              <ProjectCard key={project._id} project={project} className="border-amber-200/60 bg-gradient-to-br from-amber-50/30 to-white" />
            ))
          )}
        </div>
      </div>
